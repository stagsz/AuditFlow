...
Subject: ISO 9001 proof without hiring a quality manager
...
- For founders
- For buyers in procurement-driven markets

## 4. Content links
- Primary post: `marketing/blog/smb-iso-9001-light-qm.md`
- Frontend page: `frontend/src/app/blog/smb-iso-9001-light-qm/page.mdx`
- Index entry: `frontend/src/app/blog/index.mdx`

## 5. Production notes
- Publish via the existing blog route after approval.
- Keep tone concise and practical for SMB buyers.
- Do not add publishing automation that bypasses director approval.
